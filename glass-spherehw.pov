...
light_source {
	...
	sphere {
 	...
 	sphere {
 	       ...
 	       texture{
 	       		pigment {White filter 0.75}
 	       		finish{ diffuse 0.0 ambient 0.2 reflection 0.12 refraction 1.75 ior 1.45 specular 1.0 roughness 0.001}
 	       	}
 	}

//I think what the index of refraction changes is the amount of light that is refracted back through the sphere